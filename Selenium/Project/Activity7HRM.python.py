...
with webdriver.Firefox(service=service) as driver:
    ...
    driver.find_element(By.XPATH, "//input[@id='experience_employer']").send_keys("Nanss")
    driver.find_element(By.XPATH, "//input[@id='experience_jobtitle']").send_keys("Vice President")
